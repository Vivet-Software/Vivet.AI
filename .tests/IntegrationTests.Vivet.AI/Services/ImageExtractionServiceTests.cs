...
[TestClass]
public class ImageExtractionServiceTests : BaseTests
{
    private IImageExtractionService ImageExtractionService => this.ServiceProvider.GetRequiredService<IImageExtractionService>();
    ...
    public async Task ExtractTest()
    {
        ...
        var response = await this.ImageExtractionService
            .Extract(new ImageExtractionRequest
            {
                Blob = new ImageBlob
                {
