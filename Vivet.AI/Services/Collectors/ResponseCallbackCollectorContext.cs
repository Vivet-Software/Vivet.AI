...
internal static class ResponseCallbackCollectorContext
{
    ...
    internal static ResponseCallbackCollector ResponseCallbacks => ResponseCallbackCollectorContext.responseCallbacks.Value ?? throw new ArgumentNullException(nameof(responseCallbacks.Value));
    ...
    {
        ResponseCallbackCollectorContext.responseCallbacks.Value = null;
    }
}