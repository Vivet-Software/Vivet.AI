...
// BUG: Memory / Knowledge should maybe also be a plugin, and let the LLM choose (THIS COULD BE TRUE FOR ALL PLUGINS, MAYBE A SETTING)
// There could be questions where knowledge and Memory are not relevant. E.g. "What's the weather today?".
// Consider changing it to plugins.
// Check annotations of Memory / Knowledge for TextSearch
