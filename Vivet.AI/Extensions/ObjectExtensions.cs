...
internal static class ObjectExtensions
{
    ...
    private static void ValidateObjectRecursive(this object @object, List<ValidationResult> results, HashSet<object> visited)
    {
        ...
        {
            if (property.PropertyType.IsGenericType && (property.PropertyType.GetGenericTypeDefinition() == typeof(Dictionary<,>) || property.PropertyType.GetGenericTypeDefinition() == typeof(IDictionary<,>)))
            {
                continue;
            }
